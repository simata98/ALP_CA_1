  ...
  <v-dialog v-model="control.dialog" scrollable>
    <v-card class="pa-3">
      ...
      <v-row justify="center" class="pa-2">
        <v-card-actions>
          <v-btn elevation="2" class="ma-2" @click="insertSelectedDocs()"
            >Insert</v-btn
          >
          <v-btn elevation="2" class="ma-2" @click="deleteSelectedDocs()"
            >Delete</v-btn
          >
          <v-btn elevation="2" class="ma-2" @click="control.dialog = false"
            >Close</v-btn
          >
        </v-card-actions>
      </v-row>
